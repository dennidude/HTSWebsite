    ...
    <body>
        <div id="content">
            <div id="top">
			   ...
			   <br />
			   <!--&nbsp; &nbsp; &nbsp; <img src="images\playership1_idle1_edited.png" alt="Logga"> 
			   <br />
			   &nbsp; &nbsp;<img src="images\playershipevil_edited.png" alt="Logga">
				-->
				<img src="images\top-logo-big.png" alt="Logga">
               <div id="logo-center" ></div>
               <div id="logo-right" ></div>
            </div>
            <div id="left">
					<div class="dokument-item">
						<h1 class="dokument-item-header">- - - Meny - - -</h1>
						<!--<p class="dokument-item-description">Startsida</p>-->
...
<br />
<li><a href="sida2.php">Bildgalleri</a></li>
<br />
	...
	<!--
		...
		-->
           ...
           <!-- <div id="right">
			...
			<div id="footer">
				<p> &nbsp; &copy; 2013 Dennis Sarafiloski
				</p>
			</div>
        </div>
    </body>
